...
const previewArticles = [
  {
    title: "グループの切り替え方法",
    content:
      `上部に表示されているグループ名をクリックすると、所属している他のグループ一覧が表示されます。そこから簡単にグループを切り替えることができます。`,
  },
  {
    title: "新しいグループを作ってみましょう",
    content:
      `画面右上のボタンから、新しいグループを作成できます。用途に応じて複数のグループを作って切り替えることができます。`,
  },
  {
    title: "グループにユーザーを招待できます",
    content:
      `サイドバーの「メンバー」から他のユーザーをこのグループに招待できます。`,
  },
  {
    title: "ようこそ！",
    content:
      `これはプレビュー用のグループです。このアプリでは、ユーザーが自由に投稿を行えるグループ機能を提供しています。`,
  },
]
...
export default async function createPreviewGroup(){
  ...
  redirect(`/group/${previewGroup.groupId}/home`);
}